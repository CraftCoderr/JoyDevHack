...
class _AccountNote extends State<AccountNote> {
  ...
  @override
  void initState() {
    userSelf = FirebaseChatCore.instance.firebaseUser;
    _firstName = userSelf!.firstName!;
    _lastName = userSelf!.lastName!;
    super.initState();
  }
                                    ...
                                    if (userSelf!.firstName != _firstName ||
                                      ...
                                      FirebaseChatCore.instance
                                          .updateUserInFireStore(
                                              userSelf!, _firstName, _lastName);
                                      // setState(() {
                                      //   userSelf = userSelf!.copyWith(
                        ...
                        child: Column(
                          children: <Widget>[
                            TextFormField(
                              ...
                              maxLength: 30,
                              style: _editingTextStyle,
                              decoration: inputDecor('Firstname'),
                              validator: (value) {
                            ...
                            TextFormField(
                              ...
                              maxLength: 30,
                              style: _editingTextStyle,
                              decoration: inputDecor('Lastname'),
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Field must not be empty';
                                } else {
